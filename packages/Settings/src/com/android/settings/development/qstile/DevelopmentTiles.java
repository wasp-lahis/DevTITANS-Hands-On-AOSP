...
public abstract class DevelopmentTiles extends TileService {
    ...
    public static final String LLM_NOTIFICACAO = "com.android.llm_notificacao";
    ...
    public static class LLMNotification extends DevelopmentTiles {
        private static final int SETTING_VALUE_ON = 1;
        private static final int SETTING_VALUE_OFF = 0;
        private Context mContext;
        ...
        @Override
        protected boolean isEnabled() {
            final String value = SystemProperties.get(LLM_NOTIFICACAO);
            return value.equals("1");
        }

        @Override
        protected void setIsEnabled(boolean isEnabled) {
            SystemProperties.set(LLM_NOTIFICACAO, isEnabled ? "1" : "0");
        }
    }
