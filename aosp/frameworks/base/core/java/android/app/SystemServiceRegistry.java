 ...
 */
 ...
 public final class SystemServiceRegistry {
     ...
     static {
         ...
         registerService(Context.WASP_SERVICE, WaspManager.class,
             new CachedServiceFetcher<WaspManager>(){
                 @Override
                 public WaspManager createService(ContextImpl ctx) throws ServiceNotFoundException {
                     Log.d(TAG, "Wasp Service in service registry");
                     IBinder binder = ServiceManager.getService(Context.WASP_SERVICE);
                     IWaspService service = IWaspService.Stub.asInterface(binder);
                     Log.d(TAG, "calling manager constructor service");
                     return new WaspManager(ctx,service);
                 }
             });
