 ...
 */
 ...
 public class NotificationContentView extends FrameLayout implements NotificationFadeAware {
     ...
     private void updateViewVisibilities(int visibleType) {
         ...
         //TextView textViewAppName = mExpandedChild.findViewById(com.android.internal.R.id.app_name_text);
         
         try {
             if (mContractedChild != null) {
                 
                 TextView textView = mContractedChild.findViewById(com.android.internal.R.id.text);
                 
                     if (/*textViewAppName != null && */textView != null) {
                         //String appName = textViewAppName.getText().toString();
                         StatusBarNotification sbn = mContainingNotification.getEntry().getSbn();
                         String originalText = textView.getText().toString();
                         String appName = sbn.getPackageName();
                     
 
                     if (mWaspManager != null) {
                         String modifiedText = mWaspManager.getModifiedText(appName);
             ...
             Log.e(TAG, "Error modifying notification text", e);
         }
     ...
     private String getSystemPropertyViaProp(String prop) {
         try {
             ...
             Log.e(TAG, "Failed to get system property via getprop: " + prop, e);
             return null;
         }
     }
